...
#ifndef RC522_MFRC522_H_
#define RC522_MFRC522_H_
...
void PCD_WriteRegisterPCD_WriteRegisterBuffer(byte reg, byte count, byte *values);
byte PCD_ReadRegister(byte reg);
void PCD_ReadRegisterBuffer(byte reg, byte count, byte *values, byte rxAlign);
